...
class _MyAppState extends State<MyApp> {
  ...
  dynamic formData = {};
  //SSL Commerze credential
  var sslStoreKey="your store key";
  var sslStorePass="your store password";
 ...
 Future<void> sslCommerzCustomizedCall() async {
    ...
    if (result is PlatformException) {
      ...
      print("result:${model.storeAmount}");
      print("resut:${model.bankTranId}");
      print("${model.status}");
